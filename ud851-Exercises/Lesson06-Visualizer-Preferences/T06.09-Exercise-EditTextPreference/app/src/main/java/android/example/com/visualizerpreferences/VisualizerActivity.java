...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setMinSizeScale(Float.valueOf(sharedPreferences.getString(getString(R.string.pref_size_multiplier_key),
                getString(R.string.pref_size_multiplier_default_value))));
